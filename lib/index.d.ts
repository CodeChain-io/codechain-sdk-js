...
declare class SDK {
    ...
    static util: {
        ...
        signSchnorr: (message: string, priv: string) => import("./utils").SchnorrSignature;
        verifySchnorr: (message: string, signature: import("./utils").SchnorrSignature, pub: string) => boolean;
        recoverSchnorr: (message: string, signature: import("./utils").SchnorrSignature) => string;
