 ...
 */
exports.signSchnorr = (message, priv) => codechain_primitives_1.signSchnorr(message, priv);
/**
 ...
 */
exports.verifySchnorr = (message, signature, pub) => codechain_primitives_1.verifySchnorr(message, signature, pub);
/**
 ...
 */
exports.recoverSchnorr = (message, signature) => codechain_primitives_1.recoverSchnorr(message, signature);
/**
