...
class ChainRpc {
    ...
    sendParcel(parcel, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { nonce = yield this.getNonce(account) } = options || {};
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (Array.isArray(result)) {
                    return result.map((invoice) => Invoice_1.Invoice.fromJSON(invoice));
                }
     ...
     */
    getTransactionInvoice(txhash, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!H256_1.H256.check(txhash)) {
     ...
     */
    getNonce(address, blockNumber) {
        if (!codechain_primitives_1.PlatformAddress.check(address)) {
            throw Error(`Expected the first argument of getNonce to be a PlatformAddress value but found ${address}`);
        }
        if (blockNumber !== undefined && !isNonNegativeInterger(blockNumber)) {
            throw Error(`Expected the second argument of getNonce to be a number but found ${blockNumber}`);
        }
        return new Promise((resolve, reject) => {
            this.rpc
     ...
     */
    getAssetSchemeByHash(txhash, shardId, worldId) {
        if (!H256_1.H256.check(txhash)) {
        ...
        if (!isWorldIdValue(worldId)) {
            throw Error(`Expected the third argument of getAssetSchemeByHash to be a world ID value but found ${shardId}`);
        }
        return new Promise((resolve, reject) => {
            this.rpc
