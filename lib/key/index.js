...
class Key {
    ...
    signParcel(parcel, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { account, passphrase, keyStore = yield this.ensureKeyStore(), fee, nonce } = params;
            if (!isKeyStore(keyStore)) {
                throw Error(`Expected keyStore param to be a KeyStore instance but found ${keyStore}`);
            }
            ...
            if (!classes_1.U256.check(nonce)) {
                throw Error(`Expected nonce param to be a U256 value but found ${nonce}`);
            }
            parcel.setFee(fee);
    ...
    signTransactionInput(tx, index, params = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            tx.inputs[index].setLockScript(P2PKH_1.P2PKH.getLockScript());
            ...
            tx.inputs[index].setUnlockScript(yield p2pkh.createUnlockScript(publicKeyHash, tx.hashWithoutScript({
                tag: signatureTag,
                type: "input",
                index
            }), {
