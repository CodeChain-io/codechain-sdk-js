...
class P2PKH {
     ...
     */
    signInput(transaction, index, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const { passphrase } = options;
            ...
            transaction.inputs[index].setUnlockScript(yield this.createUnlockScript(publicKeyHash, transaction.hashWithoutScript(), { passphrase }));
        });
    }
